classdef ChaserMHE
    ...
    methods (Static)
        ...
        function states = optimize(measurements,u,weight0, weightW, weightV,traj0,N,tstep,R)
            %{
            ...
            ub = zeros(15*N,1) + Inf;
            nonlincon = @nonlcon;
            xstar = fmincon(objective, x0, A, b, Aeq, beq, lb, ub, nonlincon);
